...
- Import by dropping an image, hovering over the import target to paste an image or URL, or using the URL field for an `http`, `https`, current-page `blob`, or `data:` image URL.
