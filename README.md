...
- Import by dropping or pasting an image into the import target, clicking its **click to choose** link, or using the URL field for an `http`, `https`, current-page `blob`, or `data:` image URL.
